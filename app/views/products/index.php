                ...
                <div class="mt-3 mb-2">
                    ...
                    <div class="catalog_detail">
                        <form action="/products/load_prod_cata" method="POST">
                            ...
                            <button type="submit"
                                class="catalog-btn">Trái cây giảm giá</button>
                        </form>
                        <hr>
            ...
            <div class="col col-10">
                ...
                <?php if (isset($productbycata)): ?>
                    <div
                        ...
                        <div class="row row-cols-2 row-cols-md-4 g-5 product-list">
                            <?php
                        ...
                        <?php if (count($productbycata->product_list) > 5): ?>
                ...
                <?php else: ?>
                    ...
                    <div
                        ...
                        <div class="row row-cols-2 row-cols-md-5 g-4 product-list">
                            ...
                            $products2 = $catalogs[0]['product_list'] ?? [];
                            ?>
