        ...
        <div class="col product-item1" style="display: <?php echo $index1 < 4 ? 'block' : 'none'; ?>;">
          <a href="<?= '/products/proddetail/' . $this->e($product1['id_product']) ?>">
            <div class="card h-100">
              ...
              <div class="font-card">
                <h3 class="mt-3 mx-2"><b><?php echo htmlspecialchars($product1['name']); ?></b></h3>
                <div class="hidden">
    ...
    <div class="row row-cols-2 row-cols-md-6 g-4 product-list">
      <?php foreach ($products1 as $index => $product2): ?>
        ...
        <div class="card h-100 position-relative">
            ...
            <div class="card-body">
              <h5 class="card-title fs-4" style="height: 36px;"><?php echo htmlspecialchars($product2['name']); ?></h5>
    ...
    <div class="row row-cols-2 row-cols-md-6 g-4 product-list">
      <?php foreach ($products2 as $index => $product3): ?>
        ...
        <div class="card h-100 position-relative">
            ...
            <div class="card-body">
              <h5 class="card-title fs-4" style="height: 36px;"><?php echo htmlspecialchars($product3['name']); ?></h5>
