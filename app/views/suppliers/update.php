    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            <div class="card profile-card shadow">
                ...
                <div class="card-body">
                    <h2 class="text-center fw-bold text-success mb-4">Cập nhật nhà cung cấp</h2>
                    ...
                    <form action="/suppliers/update" method="POST">
                        ...
                        <button type="submit" class="btn btn-submit w-100 fw-bold mb-3">Cập nhật nhà cung cấp</button>
                        <a href="/suppliers/admin" class="btn btn-outline-secondary w-100 fw-bold mb-3">
